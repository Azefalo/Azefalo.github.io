...
Create a file named `/stc/avahi/services/ssh.service` by typing:
...
Don't forget also to restart the avahi-daemon by typing:

```bash
sudo systemctl restart avahi-daemon
```

To see what is the name of yours `<hostname>`, you can just type:
